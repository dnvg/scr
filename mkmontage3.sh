...
do
	...
	full_img_w=$((page_w - dist - dist))
	full_img_h=$( convert $img1[$full_img_w'x'] +repage miff:- | identify -ping -format %h - )

	#PAGE HEIGHT
	page_h=$((dist + big_img_h + dist + med_img_h + dist + med_img_h + dist + big_img_h + dist))
	...
	#3
	row3_img1_x=$dist
	row3_img1_y=$((row2_img2_y + med_img_h + dist))

	row3_img2_x=$((row3_img1_x + med_img_w + dist))
	row3_img2_y=$row3_img1_y

	#4
	row4_img1_x=$dist
	row4_img1_y=$((row3_img1_y + med_img_h + dist))

	row4_img2_x=$dist
	row4_img2_y=$((row4_img1_y + sm_img_h + dist))

	row4_img3_x=$((dist + sm_img_w + dist))
	...
	convert -verbose -size $page_w'x'$page_h xc:none \
		...
		-page +$row1_img3_x+$row1_img3_y	$img3['x'$sm_img_h] \
		-page +$row2_img1_x+$row2_img1_y	$img1['x'$med_img_h] \
		-page +$row2_img2_x+$row2_img2_y	$img5['x'$med_img_h] \
		-page +$row3_img1_x+$row3_img1_y	$img6['x'$med_img_h] \
		-page +$row3_img2_x+$row3_img2_y	$img10['x'$med_img_h] \
		-page +$row4_img1_x+$row4_img1_y	$img8['x'$sm_img_h] \
		-page +$row4_img2_x+$row4_img2_y	$img9['x'$sm_img_h] \
		-page +$row4_img3_x+$row4_img3_y	$img7['x'$big_img_h] \
